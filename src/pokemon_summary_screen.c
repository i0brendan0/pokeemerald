...
static const u8 sMoveTypeToOamPaletteNum[NUMBER_OF_MON_TYPES + CONTEST_CATEGORIES_COUNT] =
{
    ...
    [TYPE_POISON] = TYPE_ICON_PAL_2,
    [TYPE_GROUND] = TYPE_ICON_PAL_1,
    [TYPE_ROCK] = TYPE_ICON_PAL_1,
    [TYPE_BUG] = TYPE_ICON_PAL_3,
    [TYPE_DARK] = TYPE_ICON_PAL_1,
    [TYPE_STEEL] = TYPE_ICON_PAL_1,
    [TYPE_MYSTERY] = TYPE_ICON_PAL_3,
    [TYPE_FIRE] = TYPE_ICON_PAL_1,
    [TYPE_WATER] = TYPE_ICON_PAL_2,
    [TYPE_GRASS] = TYPE_ICON_PAL_3,
    [TYPE_ELECTRIC] = TYPE_ICON_PAL_1,
    [TYPE_PSYCHIC] = TYPE_ICON_PAL_2,
    [TYPE_ICE] = TYPE_ICON_PAL_2,
    [TYPE_DRAGON] = TYPE_ICON_PAL_3,
    [TYPE_GHOST] = TYPE_ICON_PAL_2,
	[TYPE_FAIRY] = TYPE_ICON_PAL_2,
    [NUMBER_OF_MON_TYPES + CONTEST_CATEGORY_COOL] = TYPE_ICON_PAL_1,
    [NUMBER_OF_MON_TYPES + CONTEST_CATEGORY_BEAUTY] = TYPE_ICON_PAL_2,
    [NUMBER_OF_MON_TYPES + CONTEST_CATEGORY_CUTE] = TYPE_ICON_PAL_2,
    [NUMBER_OF_MON_TYPES + CONTEST_CATEGORY_SMART] = TYPE_ICON_PAL_3,
    [NUMBER_OF_MON_TYPES + CONTEST_CATEGORY_TOUGH] = TYPE_ICON_PAL_1,
};
