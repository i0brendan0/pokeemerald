...
const u32 gItemIconPalette_PinkBow[] = INCBIN_U32("graphics/items/icon_palettes/pink_bow.gbapal.lz");

const u32 gItemIcon_ColorFeather[] = INCBIN_U32("graphics/items/icons/color_feather.4bpp.lz");
const u32 gItemIconPalette_BlueFeather[] = INCBIN_U32("graphics/items/icon_palettes/blue_feather.gbapal.lz");
const u32 gItemIconPalette_YellowFeather[] = INCBIN_U32("graphics/items/icon_palettes/yellow_feather.gbapal.lz");
const u32 gItemIconPalette_RedFeather[] = INCBIN_U32("graphics/items/icon_palettes/red_feather.gbapal.lz");
...
//const u32 gItemIcon_MusicBox[] = INCBIN_U32("graphics/items/icons/music_box.4bpp.lz");
//const u32 gItemIconPalette_MusicBox[] = INCBIN_U32("graphics/items/icon_palettes/music_box.gbapal.lz");
const u32 gItemIcon_LegLoop[] = INCBIN_U32("graphics/items/icons/leg_loop.4bpp.lz");
const u32 gItemIconPalette_RadianceLoop[] = INCBIN_U32("graphics/items/icon_palettes/leg_loop_rai.gbapal.lz");
const u32 gItemIconPalette_WildfireLoop[] = INCBIN_U32("graphics/items/icon_palettes/leg_loop_ent.gbapal.lz");
const u32 gItemIconPalette_TempestLoop[] = INCBIN_U32("graphics/items/icon_palettes/leg_loop_sui.gbapal.lz");
const u32 gItemIcon_TidalBell[] = INCBIN_U32("graphics/items/icons/tidal_bell.4bpp.lz");
const u32 gItemIconPalette_TidalBell[] = INCBIN_U32("graphics/items/icon_palettes/tidal_bell.gbapal.lz");
const u32 gItemIcon_ClearBell[] = INCBIN_U32("graphics/items/icons/clear_bell.4bpp.lz");
const u32 gItemIconPalette_ClearBell[] = INCBIN_U32("graphics/items/icon_palettes/clear_bell.gbapal.lz");
...
const u32 gItemIcon_RegiPart[] = INCBIN_U32("graphics/items/icons/regi_part.4bpp.lz");
const u32 gItemIconPalette_RedPart[] = INCBIN_U32("graphics/items/icon_palettes/red_part.gbapal.lz");
const u32 gItemIconPalette_BluePart[] = INCBIN_U32("graphics/items/icon_palettes/blue_part.gbapal.lz");
const u32 gItemIconPalette_GrayPart[] = INCBIN_U32("graphics/items/icon_palettes/gray_part.gbapal.lz");
//const u32 gItemIcon_WishStone[] = INCBIN_U32("graphics/items/icons/wish_stone.4bpp.lz");
//const u32 gItemIconPalette_WishStone[] = INCBIN_U32("graphics/items/icon_palettes/wish_stone.gbapal.lz");
const u32 gItemIcon_SpaceGlobe[] = INCBIN_U32("graphics/items/icons/space_globe.4bpp.lz");
const u32 gItemIconPalette_SpaceGlobe[] = INCBIN_U32("graphics/items/icon_palettes/space_globe.gbapal.lz");
