...
static const u16 sPickupItemsLvl50[TOTAL_ROUNDS][PICKUP_ITEMS_PER_ROUND] =
{
    ...
    {ITEM_HYPER_POTION, ITEM_X_SPECIAL,   ITEM_PECHA_BERRY,  ITEM_ETHER, ITEM_LUM_BERRY,   ITEM_REVIVE, ITEM_SCOPE_LENS,    ITEM_FOCUS_BAND,  ITEM_MAX_REVIVE,   ITEM_SACRED_ASH},
