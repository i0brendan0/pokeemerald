...
{
    {SPECIES_ARTICUNO,  HOLD_EFFECT_BLUE_FEATHER},
    {SPECIES_ZAPDOS,    HOLD_EFFECT_YELLOW_FEATHER},
    {SPECIES_MOLTRES,   HOLD_EFFECT_RED_FEATHER},
    {SPECIES_MEWTWO,    HOLD_EFFECT_BERSERK_GENE},
    {SPECIES_MEW,       HOLD_EFFECT_MUSIC_BOX},
    {SPECIES_RAIKOU,    HOLD_EFFECT_RADIANCE_LOOP},
    {SPECIES_ENTEI,     HOLD_EFFECT_WILDFIRE_LOOP},
    {SPECIES_SUICUNE,   HOLD_EFFECT_TEMPEST_LOOP},
    {SPECIES_LUGIA,     HOLD_EFFECT_TIDAL_BELL},
    {SPECIES_HO_OH,     HOLD_EFFECT_CLEAR_BELL},
    {SPECIES_CELEBI,    HOLD_EFFECT_GS_BALL},
    {SPECIES_REGIROCK,  HOLD_EFFECT_ROCK_PART},
    {SPECIES_REGICE,    HOLD_EFFECT_ICE_PART},
    {SPECIES_REGISTEEL, HOLD_EFFECT_STEEL_PART},
    {SPECIES_GROUDON,   HOLD_EFFECT_RUBY},
    {SPECIES_KYOGRE,    HOLD_EFFECT_SAPPHIRE},
    {SPECIES_RAYQUAZA,  HOLD_EFFECT_EMERALD},
    {SPECIES_JIRACHI,   HOLD_EFFECT_WISH_STONE},
    {SPECIES_DEOXYS,    HOLD_EFFECT_SPACE_GLOBE},
};
