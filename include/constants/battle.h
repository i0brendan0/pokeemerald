...
#define STATUS2_MIRACLE_EYE           (1 << 7)
...
#define WEATHER_RAIN_ANY            (WEATHER_RAIN_TEMPORARY | WEATHER_RAIN_PERMANENT)
#define WEATHER_SANDSTORM_TEMPORARY (1 << 2)
#define WEATHER_SANDSTORM_PERMANENT (1 << 3)
#define WEATHER_SANDSTORM_ANY       (WEATHER_SANDSTORM_TEMPORARY | WEATHER_SANDSTORM_PERMANENT)
#define WEATHER_SUN_TEMPORARY       (1 << 4)
#define WEATHER_SUN_PERMANENT       (1 << 5)
#define WEATHER_SUN_ANY             (WEATHER_SUN_TEMPORARY | WEATHER_SUN_PERMANENT)
#define WEATHER_HAIL_TEMPORARY      (1 << 6)
#define WEATHER_HAIL_PERMANENT      (1 << 7)
