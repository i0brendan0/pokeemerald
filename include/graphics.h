...
extern const u32 gItemIconPalette_PinkBow[];
extern const u32 gItemIcon_ColorFeather[];
extern const u32 gItemIconPalette_BlueFeather[];
extern const u32 gItemIconPalette_YellowFeather[];
extern const u32 gItemIconPalette_RedFeather[];
extern const u32 gItemIcon_BerserkGene[];
extern const u32 gItemIconPalette_BerserkGene[];
extern const u32 gItemIcon_MusicBox[];
extern const u32 gItemIconPalette_MusicBox[];
extern const u32 gItemIcon_LegLoop[];
extern const u32 gItemIconPalette_RadianceLoop[];
extern const u32 gItemIconPalette_WildfireLoop[];
extern const u32 gItemIconPalette_TempestLoop[];
extern const u32 gItemIcon_TidalBell[];
extern const u32 gItemIconPalette_TidalBell[];
extern const u32 gItemIcon_ClearBell[];
extern const u32 gItemIconPalette_ClearBell[];
extern const u32 gItemIcon_GSBall[];
extern const u32 gItemIconPalette_GSBall[];
extern const u32 gItemIcon_RegiPart[];
extern const u32 gItemIconPalette_RedPart[];
extern const u32 gItemIconPalette_BluePart[];
extern const u32 gItemIconPalette_GrayPart[];
extern const u32 gItemIcon_WishStone[];
extern const u32 gItemIconPalette_WishStone[];
extern const u32 gItemIcon_SpaceGlobe[];
extern const u32 gItemIconPalette_SpaceGlobe[];
// Contest hold items
